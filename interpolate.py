"""
This part is taken from tensorflow addons image module. Available from tensorflow 2.3.0 and beyond.
"""
...
def interpolate_bilinear(
    grid: utils.TensorLike,
    query_points: utils.TensorLike,
    indexing: str = "ij",
...
def dense_image_warp(
    image: utils.TensorLike, flow: utils.TensorLike, name: Optional[str] = None
):
    """Image warping using per-pixel flow vectors.
